...
CREATE TABLE IF NOT EXISTS `frisko`.`aros_acos` (
  ...
  CONSTRAINT `aro_id_fk_ac`
    FOREIGN KEY (`aro_id`)
    REFERENCES `frisko`.`aros` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `aco_id_fk_ac`
    FOREIGN KEY (`aco_id`)
    REFERENCES `frisko`.`acos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 2
...
CREATE TABLE IF NOT EXISTS `frisko`.`compras` (
  ...
  `pagado` TINYINT NOT NULL DEFAULT 0 COMMENT '0=No Pagado\n1=Pagado',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `frisko`.`orden_compras` (
  ...
  `total` DECIMAL(10,2) NOT NULL DEFAULT '0.00',
  `impuesto` DECIMAL(10,2) NOT NULL DEFAULT '0.00',
  `gran_total` DECIMAL(10,2) NOT NULL DEFAULT '0.00',
...
CREATE TABLE IF NOT EXISTS `frisko`.`ventas` (
  ...
  `grantotal` DECIMAL(10,2) NOT NULL DEFAULT '0.00',
  `estado` TINYINT(4) NOT NULL DEFAULT '0' COMMENT '0=Grabado\n1=Procesado',
  `cobrado` TINYINT NOT NULL DEFAULT 0 COMMENT '0= No pagado\n1= Pagado',
  PRIMARY KEY (`id`),
  UNIQUE INDEX `codigo_unico_UNIQUE` (`codigo_unico` ASC),
...
CREATE TABLE IF NOT EXISTS `frisko`.`ventas_detalle` (
  ...
  `incluir_impuesto` TINYINT NOT NULL DEFAULT 0,
  `tasa_impuesto` DECIMAL(10,2) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `frisko`.`cargos` (
  ...
  `incluir_impuesto` TINYINT NULL DEFAULT 0 COMMENT '0=No incluye impuesto\n1=Incluye Impuesto',
  `nombre` VARCHAR(255) NOT NULL,
  `total` DECIMAL(10,2) NOT NULL DEFAULT 0,
  `estado` TINYINT NOT NULL DEFAULT 1,
  `created` DATETIME NOT NULL,
  `modified` DATETIME NOT NULL,
  `tipo_cargo` TINYINT NOT NULL DEFAULT 0 COMMENT '0=Cargo Fijo\n1=Cargo Variable',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `frisko`.`cajas_movimientos` (
  ...
  `salida` DECIMAL(10,2) NULL,
  `created` DATETIME NOT NULL,
  `updated` DATETIME NOT NULL,
  `tipo_movimiento` TINYINT NOT NULL DEFAULT 0 COMMENT '0=Entrada\n1=Salida',
  PRIMARY KEY (`id`),
