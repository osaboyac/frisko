<div class="panel panel-primary">
	...
	<div class="box-body">
		...
		<div class="form-group">
			<?php 
				echo $this->Form->input('departamento_id', ['options' => $departamentos,'empty'=>true,'class'=>'form-control select2','required'=>true]);
				echo $this->Form->input('provincia_id', ['options'=>'','empty'=>true,'class'=>'form-control','required'=>true]);
