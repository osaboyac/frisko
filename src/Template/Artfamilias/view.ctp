<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Artfamilia'), ['action' => 'edit', $artfamilia->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Artfamilia'), ['action' => 'delete', $artfamilia->id], ['confirm' => __('Are you sure you want to delete # {0}?', $artfamilia->id)]) ?> </li>
        <li><?= $this->Html->link(__('List Artfamilias'), ['action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New Artfamilia'), ['action' => 'add']) ?> </li>
        <li><?= $this->Html->link(__('List Articulos'), ['controller' => 'Articulos', 'action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New Articulo'), ['controller' => 'Articulos', 'action' => 'add']) ?> </li>
    </ul>
</nav>
<div class="artfamilias view large-9 medium-8 columns content">
    <h3><?= h($artfamilia->id) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($artfamilia->articulos)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($artfamilia->articulos as $articulos): ?>
            <tr>
