...
class CargosController extends AppController
{
    ...
    public function view($id = null)
    {
        $cargo = $this->Cargos->get($id, [
            'contain' => ['Socios', 'Impuestos', 'CajasMovimientos']
        ]);
    ...
    public function add()
    {
        ...
        $socios = $this->Cargos->Socios->find('list', ['limit' => 200]);
        $impuestos = $this->Cargos->Impuestos->find('list', ['limit' => 200]);
        $this->set(compact('cargo', 'socios', 'impuestos'));
        $this->set('_serialize', ['cargo']);
    }
